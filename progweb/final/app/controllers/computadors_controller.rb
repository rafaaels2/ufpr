class ComputadorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @computador.save
        format.html { redirect_to computador_url(@computador), notice: "Computador was successfully created." }
  ...
  def update
    respond_to do |format|
      if @computador.update(computador_params)
        format.html { redirect_to computador_url(@computador), notice: "Computador was successfully updated." }
