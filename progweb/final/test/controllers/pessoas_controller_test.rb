...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { cidade: @pessoa.cidade, idade: @pessoa.idade, nome: @pessoa.nome, rg: @pessoa.rg } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { cidade: @pessoa.cidade, idade: @pessoa.idade, nome: @pessoa.nome, rg: @pessoa.rg } }
