...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference("Carro.count") do
      post carros_url, params: { carro: { crv: @carro.crv, marca: @carro.marca, nome: @carro.nome, pessoa_id: @carro.pessoa_id } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { crv: @carro.crv, marca: @carro.marca, nome: @carro.nome, pessoa_id: @carro.pessoa_id } }
